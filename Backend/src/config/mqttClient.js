...
//     'user/listenDriver',
//     'user/postAllDrivers',
//     'user/postVehicle/driver',
//     'web/postAllZoneDrivers',
//     'web/getAllZoneDrivers',
//     'user/postTripDriver',
//     'post/tripDetails',
//     'post/trip/waitingTime',
//     'user/request/pickup',
//     'user/request/drop',
//     'user/request/stop'
// ];
...
client.on('message', async (topic, message, packet) => {
  try {
    ...
    // Switch case to handle different topics

    // switch (topic) {
    //     case 'driver/locationUpdate': // mobile
    //         driverLocation(message);
    //         break;
    //     case 'user/postAllDrivers': // mobile
    //         getAllDriverLocation(message.toString());
    //         break;
    //     case 'user/postVehicle/driver': // mobile
    //         getVehicleLocation(message.toString());
    //         break;
    //     case 'user/request/pickup': // mobile
    //         getpickupEditRequest(message.toString());
    //         break;
    //     case 'user/request/drop': // mobile
    //         getEndEditRequest(message.toString());
    //         break;
    //     case 'user/request/stop': // mobile
    //         getStopEditRequest(message.toString());
    //         break;
    //     case 'web/postAllZoneDrivers': // web
    //         getAllZoneDriverLocation(message.toString());
    //         break;
    //     case 'user/postTripDriver': // web
    //         postTripDrivers(message.toString());
    //         break;
    //     case 'post/tripDetails': // web
    //         postTripDetails(message.toString());
    //     case 'post/trip/waitingTime': // web
    //         postTripWaiting(message.toString());
    //         break;
    //     case 'user/listenDriver': // mobile
    //         break;
    //     case 'driver/detail': // mobile
    //         break;
    //     case 'web/getAllZoneDrivers': // web
    //         break;
    //     default:
    // }
...
const driverLocation = async (data) => {
  try {
    ...
    const transformedData = {
      ...
      vehicleId: jsonData.vehicleId ? new mongoose.Types.ObjectId(jsonData.vehicleId) : null,
