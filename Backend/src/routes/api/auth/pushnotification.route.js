...
router.post('/send', auth('SendNotifications'), pushNotificationUpload.single('image'), notificationController.pushNotification);
...
router.route('/deleteNotification/:notificationId').delete(auth('SendNotifications'),notificationController.deleteNotification);
router.route('/getDropDown/list/:clientId').get(notificationController.getDropDownList);
...
router.route('/updateNotification/:notificationId').patch(auth('SendNotifications'), notificationController.updatePushNotification);
