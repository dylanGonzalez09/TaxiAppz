...
const ticketValidation = require('../../../validations/api/auth/ticket.validation.js');
const ticketController = require('../../../controllers/api/auth/ticket.controller.js');
...
router
  ...
  .patch(auth('Ticket'), validate(ticketValidation.updateTicket), ticketController.updateTicket);
router
  .route('/deleteTicket/:ticketId')
  .delete(auth('Ticket'), validate(ticketValidation.deleteTicket), ticketController.deleteTicket);
...
router.route('/getUserTickets').get(auth('Ticket'), ticketController.groupTicketsByUser);
