...
router.route('/getRequests/inprogress').get(auth('Request'), validate(requestValidation.getRequest), requestController.getRequestsInProgress);
router.route('/getRequestsList').get(auth('Request'), validate(requestValidation.getRequest), requestController.getRequestsList);
router.route('/getRequestsByView/:requestId').get(auth('Request'), validate(requestValidation.getRequestById), requestController.getRequestsListView);
...
router.route('/recents/list').get(auth('Request'), validate(requestValidation.getRequest), requestController.getLastTripHistory);
...
router.route('/convertPolygoLine').post(auth('Request'),requestController.getPolygonLine);
