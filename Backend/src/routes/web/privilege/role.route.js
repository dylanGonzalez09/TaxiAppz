...
const roleValidation = require('../../../validations/web/privilege/role.validation');
const roleController = require('../../../controllers/web/privilege/role.controller');

const router = express.Router();

router.route('/create').post(auth('Role'), validate(roleValidation.createRole), roleController.createRole);
router.route('/getRolesWithPagination').get(auth('Role'), roleController.getRoles);
router.route('/getRoles/:roleId').get(auth('Role'), validate(roleValidation.getRole), roleController.getRole);
router.route('/getRole/list').get(roleController.getRoleWithOutPagination);
router.route('/updateRoles/:roleId').patch(auth('Role'), validate(roleValidation.updateRole), roleController.updateRole);
router.route('/deleteRoles/:roleId').delete(auth('Role'), validate(roleValidation.deleteRole), roleController.deleteRole);
router.route('/getDropDown/list/:clientId').get(roleController.getDropDownList);
