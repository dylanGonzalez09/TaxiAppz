...
const sosValidation = require('../../../validations/web/master/sos.validation');
const sosController = require('../../../controllers/web/master/sos.controller');
...
router.route('/getSosWithPagination').get(auth('Sos'), sosController.getSosPagination);
