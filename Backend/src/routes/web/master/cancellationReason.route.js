...
router
  ...
  .get(auth('CancellationReason'), cancellationReasonController.getCancellationWithoutPagination);
router
  .route('/user/getCancellation/list')
  .get(auth('CancellationReason'), cancellationReasonController.getUserCancellationWithoutPagination);
router
...
router
  .route('/getCancellationByLanguage/:langId')
  .get(auth('CancellationReason'), cancellationReasonController.getCancellationByLanguage);
