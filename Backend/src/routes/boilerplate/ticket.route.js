...
const ticketValidation = require('../../validations/boilerplate/ticket.validation');
...
router.route('/adminGroupTicket/:userId').get(auth('Ticket'), ticketController.groupTicketsByAdmin);
