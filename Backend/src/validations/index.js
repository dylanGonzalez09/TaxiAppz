...
module.exports.roleValidation = require('./web/master/role.validation');
module.exports.versionValidation = require('./web/master/projectVersion.validation');
module.exports.permissionsValidation = require('./web/master/permissions.validation');
module.exports.privillegeValidation = require('./web/master/privillege.validation');
module.exports.usersValidation = require('./web/master/users.validation');
