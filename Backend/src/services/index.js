...
module.exports.companyService = require('./boilerplate/company.service');
...
module.exports.fineService = require('./web/master/fine.service');
...
module.exports.mobileCompanyService = require('./api/auth/company.service');
...
module.exports.companySubscriptionService = require('./boilerplate/companySubscription.service');
...
module.exports.apiticketService = require('./api/auth/ticket.service');


module.exports.driverSubscriptionService = require('./api/auth/driver_subscription.service');

// Web-specific services (separate from mobile/client APIs)
