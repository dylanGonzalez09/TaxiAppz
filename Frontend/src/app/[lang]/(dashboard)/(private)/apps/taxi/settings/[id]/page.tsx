...
import { getDefaultLanguage, getSettingById } from '@/app/api/apps/taxi/setting'
...
const SettingListTablePage = async ({ params }: { params: { lang: Locale; id: string } }) => {
  ...
  return <SettingListTable dictionary={dictionary} settingsData={settingsData} params={params} />
}
