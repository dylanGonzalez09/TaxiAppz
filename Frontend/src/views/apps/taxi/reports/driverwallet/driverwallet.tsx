...
const columnHelper = createColumnHelper<DriverWalletType>();
...
const DriverWalletTable = ({ staticGroup, dictionary }: { staticGroup: DriverWalletType[], dictionary: any }) => {
  ...
  const columns = useMemo<ColumnDef<DriverWalletType, any>[]>(() => [
    {
      id: 'serialNo',
    ...
    columnHelper.accessor('phoneNumber', {
      ...
      cell: ({ row }) => <Typography className='font-medium'>{row.original.phoneNumber}</Typography>,
    }),
