...
const RatingTable = (dictionary: any) => {
  // States
  const [rowSelection, setRowSelection] = useState({})
  const [globalFilter, setGlobalFilter] = useState('')

  // Sample Data (Replace this with your actual data fetching logic)
  const data: RatingListType[] = [] // Initialize with your complaint data
  ...
  const columns = useMemo<ColumnDef<RatingListType, any>[]>(() => [
    ...
    columnHelper.accessor('tripNumber', {
      ...
      cell: ({ row }) => <Typography color='text.primary'>{row.original.tripNumber}</Typography>
    }),
    ...
    columnHelper.accessor('feedBack', {
      header: dictionary['navigation'].FeedBack,
  ...
  return (
    <Card>
      <CardHeader
        title={`Rating List (${table.getFilteredRowModel().rows.length})`}
