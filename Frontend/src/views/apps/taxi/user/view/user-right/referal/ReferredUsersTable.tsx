...
const ReferalTable = (props: ReferalTabProps) => {
  ...
  return (
    <Card>
          ...
          <CardHeader  className='flex flex-wrap gap-2' title={`${dictionary['navigation'].ReferalList} (${table.getFilteredRowModel().rows.length})`} />
      ...
      <div className='flex items-center justify-between p-6 gap-4'>
        ...
        <DebouncedInput
          ...
          placeholder={dictionary['navigation'].SearchReferal}
