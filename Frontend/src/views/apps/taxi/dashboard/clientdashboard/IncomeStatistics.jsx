...
const IncomeStatistics = () => {
  ...
  const options = {
    ...
    xaxis: {
      tickAmount: 10,
      categories: ['CHENNAI', 'COIMBATORE', 'ERODE', 'SALEM', 'KARUR', 'SATHY', 'TIRCHY', 'TIRUPUR', 'GOBI', 'MADURAI'],
      labels: {
        style: {
  ...
  return (
    <Card>
      <CardHeader title='Zone wise Income' subheader='Total number of deliveries 23.8k' action={<MonthButton />} />
      <CardContent>
        <AppReactApexCharts
