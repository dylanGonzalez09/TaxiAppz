...
const CardActionRefreshContent = (dictionary:any) => {
  // States
  ...
  return (
    <Card className='relative'>
      ...
      <CardContent>
        <Typography>
        {dictionary['navigation'].Clickon} <i className='tabler-refresh text-xl align-sub' /> {dictionary['navigation'].icontoseeitinaction}
        </Typography>
      </CardContent>
