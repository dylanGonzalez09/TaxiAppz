...
const Notifications = (dictionary:any) => {
  return (
    <Card>
      <CardHeader
        ...
        subheader={
          <>
            {dictionary['navigation'].Weneedpermissionfromyourbrowsertoshownotifications}
      ...
      <Form>
        <div className='overflow-x-auto'>
          <table className={tableStyles.table}>
            <thead>
              <tr>
                <th>{dictionary['navigation'].Type}</th>
                <th>{dictionary['navigation'].Email}</th>
                <th>{dictionary['navigation'].Browser}</th>
                <th>{dictionary['navigation'].App}</th>
              </tr>
            </thead>
        ...
        <CardContent>
          <Typography className='mbe-6 font-medium'>{dictionary['navigation'].Whenshouldwesendyounotifications}</Typography>
          <Grid container spacing={6}>
            <Grid item xs={12} sm={6} md={4}>
              <CustomTextField select fullWidth defaultValue='online'>
                <MenuItem value='online'>Only when I&#39;m online</MenuItem>
                <MenuItem value='anytime'>{dictionary['navigation'].Anytime}</MenuItem>
              </CustomTextField>
            </Grid>
