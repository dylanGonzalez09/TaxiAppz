...
const TwoStepsV2 = ({ mode, dictionary }: { mode: SystemMode, dictionary: any }) => {
  // States
      ...
      <div className='flex justify-center items-center bs-full bg-backgroundPaper !min-is-full p-6 md:!min-is-[unset] md:p-12 md:is-[480px]'>
        ...
        <div className='flex flex-col gap-6 is-full sm:is-auto md:is-full sm:max-is-[400px] md:max-is-[unset] mbs-11 sm:mbs-14 md:mbs-0'>
          <div className='flex flex-col gap-1'>
            <Typography variant='h4'>{dictionary['navigation'].TwoStepVerification}</Typography>
            <Typography>
            {dictionary['navigation'].WesentaverificationcodetoyourmobileEnterthecodefromthemobileinthefieldbelow}
            </Typography>
          ...
          <Form noValidate autoComplete='off' className='flex flex-col gap-6'>
            <div className='flex flex-col gap-2'>
              <Typography>{dictionary['navigation'].Typeyoursixdigitsecuritycode}</Typography>
              <OTPInput
                onChange={setOtp}
                value={otp ?? ''}
                maxLength={6}
            ...
            {dictionary['navigation'].Verifymyaccount}
            </Button>
