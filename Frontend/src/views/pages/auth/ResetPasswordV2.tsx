...
const ResetPasswordV2 = ({ mode , dictionary }: { mode: SystemMode ; dictionary: any}) => {
  // States
      ...
      <div className='flex justify-center items-center bs-full bg-backgroundPaper !min-is-full p-6 md:!min-is-[unset] md:p-12 md:is-[480px]'>
        ...
        <div className='flex flex-col gap-6 is-full sm:is-auto md:is-full sm:max-is-[400px] md:max-is-[unset] mbs-11 sm:mbs-14 md:mbs-0'>
          <div className='flex flex-col gap-1'>
            <Typography variant='h4'>{dictionary['navigation'].ResetPassword}</Typography>
            <Typography>{dictionary['navigation'].Yournewpasswordmustbedifferentfrompreviouslyusedpasswords}</Typography>
          </div>
          ...
          <form noValidate autoComplete='off' onSubmit={handleSubmit} className='flex flex-col gap-6'>
            ...
            {dictionary['navigation'].SetNewPassword}
            </Button>
            <Typography className='flex justify-center items-center' color='primary'>
              ...
              >
                <DirectionalIcon
                  ...
                  className='text-xl'
                />
                <span>{dictionary['navigation'].Backtologin}</span>
              </Link>
            </Typography>
          </form>
        </div>
