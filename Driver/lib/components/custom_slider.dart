...
class CustomSlider extends StatefulWidget {
  ...
  final double? sliderButtonHeight;
  final double? sliderButtonWidth;
  ...
  const CustomSlider({
    ...
    this.text,
    this.textStyle,
    this.sliderButtonIcon, this.sliderButtonHeight, this.sliderButtonWidth,
  });
...
class SlideActionState extends State<CustomSlider> with TickerProviderStateMixin {
                              ...
                              child: GestureDetector(
                                ...
                                child: Padding(
                                  ...
                                  child: Material(
                                    ...
                                    child: Container(
                                      height: widget.sliderButtonHeight,
                                      width: widget.sliderButtonWidth,
