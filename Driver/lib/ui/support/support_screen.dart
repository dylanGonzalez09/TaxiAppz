...
import 'package:taxiappzpro/ui/support/support_vm.dart';
      ...
      child: DrawerScaffold(
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              HeaderView(
                title: vm.translation.txtSupport,
              ),
              ...
              InkWell(
                onTap: () async {
                  ...
                  GoRouter.of(context)
                      .pushNamed(CustomRouterConfig.complaintScreen,extra: map);
                },
                child: Row(
              ...
              InkWell(
                onTap: () async {
                  GoRouter.of(context).pushNamed(CustomRouterConfig.sosScreen);
                },
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
              ...
              InkWell(
                onTap: () async {
                  ...
                  GoRouter.of(context).pushNamed(CustomRouterConfig.faqScreen,extra: map);
                },
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        vm.translation.txtNeedAnySupport,
                        style: Theme.of(context).textTheme.bodySmall?.copyWith(
                              color: Colors.black,
                              fontSize: 15,
                            ),
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      debugPrint("object$adminPhoneNumber");
                      debugPrint("object$headOfficeNumber");
