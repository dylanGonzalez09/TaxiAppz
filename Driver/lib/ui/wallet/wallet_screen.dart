...
import 'package:taxiappzpro/ui/wallet/wallet_vm.dart';
              ...
              children: [
                Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        HeaderView(
                          title: vm.translation.txtWallet,
                          onBackPressed: () {
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          Text(
                                            "${vm.walletDetail?.currency ?? ""} ${vm.walletDetail?.balance ?? ""}",
                                            style: Theme.of(context)
                                                .textTheme
                                                .bodyLarge
                                                ?.copyWith(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Text(
                                              "${vm.walletDetail?.currency ?? ""} ${vm.walletDetail?.due ?? ""}",
                                              style: Theme.of(context)
                                                  .textTheme
                                                  .bodyLarge
                                                  ?.copyWith(
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            onTap: () async {
                              ...
                              vm.moveToNamed(
                                  CustomRouterConfig.transactionListScreen,
                                  args: map);
                            },
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    vm.translation.txtTransactionHistory,
                                    style: Theme.of(context)
                                        .textTheme
                                        .bodySmall
                                        ?.copyWith(
