                                  ...
                                  children: [
                                    ...List.generate(
                                      ...
                                      final bool isDispute = vm
                                                  ...
                                                  .isCompleted ==
                                              true &&
                                          vm.history[index].trip[filteredIndex]
                                      ...
                                      return InkWell(
                                        onTap: () {
                                          ...
                                          GoRouter.of(context).pushNamed(
                                              CustomRouterConfig.invoiceScreen,
                                                                ...
                                                                onTap: () {
                                                                  if (isDispute) {
                                                                    vm.moveToNamed(
                                                                        ...
                                                                        args: {
                                                                          AppConstants.type:
                                                                              AppConstants.dispute,
                                                                          AppConstants.requestId: vm
                                                                              .tripData[index]
                                                                              .sId,
                                                                          'trip': vm.tripData[index]
                                                                        });
                                                                  }
                                                                },
                                                                child:
