...
import 'package:taxiappzpro/ui/history/scheduleScreen/schedule_screen_vm.dart';
...
class _ScheduledScreenState extends State<ScheduledScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      vm.showScheduledHistory(1, AppConstants.SCHEDULED, "RIDE_LATER");
      ...
      if (vm.historyListModel!.page! < vm.historyListModel!.totalPages! &&
        ...
        vm
            .showScheduledHistory(
                vm.currentPage, AppConstants.SCHEDULED, "RIDE_LATER")
            .then((_) {
          setState(() {
            isLoading = false;
          });
  ...
  Widget build(BuildContext context) {
    return DrawerScaffold(
      ...
      body: ChangeNotifierProvider<ScheduleScreenVm>(
        create: (context) => vm,
        child: Consumer<ScheduleScreenVm>(builder: (_, vm, child) {
          return Padding(
                            ...
                            title: Padding(
                              ...
                              child: Text(
                                vm.formatMonthDateYear(
                                    vm.history[index].trip[index].tripStartTime
                                        .toString(),
                                    0),
