...
class CustomLoggingInterceptor extends Interceptor {
  ...
  void onError(DioException err, ErrorInterceptorHandler handler) {
    log(err.requestOptions.uri.toString(), name: "response url [${err.requestOptions.method}]");
  ...
  void onResponse(Response response, ResponseInterceptorHandler handler) {
    log(response.requestOptions.uri.toString(), name: "response url [${response.requestOptions.method} ${response.statusCode}]");
