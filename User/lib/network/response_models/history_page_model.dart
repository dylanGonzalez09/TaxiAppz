...
class HistoryPageModel {
  ...
  HistoryPageModel.fromJson(Map<String, dynamic> json) {
    if (json['results'] != null) {
      dataList = <Trip>[];
      json['results'].forEach((v) {
        dataList!.add(new Trip.fromJson(v));
      });
    }
    page = json['page'];
    limit = json['limit'];
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.dataList != null) {
      data['results'] = this.dataList!.map((v) => v.toJson()).toList();
    }
    data['page'] = this.page;
...
class Results {
  ...
  Results.fromJson(Map<String, dynamic> json) {
    ...
    placesDetails = json['placesDetails'] != null
        ? new PlacesDetails.fromJson(json['placesDetails'])
        : null;
    ...
    vehicleModelDetails = json['vehicleModelDetails'] != null
        ? new VehicleModelDetails.fromJson(json['vehicleModelDetails'])
        : null;
    ...
    ratingDetails = json['ratingDetails'] != null
        ? new RatingDetails.fromJson(json['ratingDetails'])
        : null;
  }
