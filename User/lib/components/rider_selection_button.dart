...
class RiderSelectionProceedButton extends StatelessWidget {
  final String btnTxt;
  ...
  const RiderSelectionProceedButton({
    super.key,
              ...
              children: [
                Center(
                    child: Padding(
                        ...
                        child: Text(btnTxt,
                            style: Theme.of(context).textTheme.titleLarge?.copyWith(color: isOutlinedBorderButton == true
