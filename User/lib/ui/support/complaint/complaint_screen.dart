                ...
                children: [
                          ...
                          Card(
                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                ...
                                onChanged: vm.complaintValidator,
                                style: Theme.of(context)
                                    .textTheme
                                    .bodySmall
                                    ?.copyWith(
                                ...
                                decoration: const InputDecoration.collapsed(
                                    hintText: "Enter complaints briefly"),
                              ),
                            ),
                          ),
                  ...
                  InkWell(
                    onTap: () {
                      ...
                      String text = vm.complaintController.text.trim();
                      if (text.isNotEmpty) {
                        final validationResult = vm.complaintValidator(text);
