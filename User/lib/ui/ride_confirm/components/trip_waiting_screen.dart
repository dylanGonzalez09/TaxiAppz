...
class TripWaitingScreen extends StatelessWidget {
  ...
  const TripWaitingScreen({super.key, required this.vm});
      ...
      child: Column(
        ...
        children: [
          AddressView(
            ...
            dropAddress: vm.dropModel.address, stopAddress: vm.stopModel?.address ?? '',
          ),
          const SizedBox(
          ...
          Text(vm.translation.txt_Your_ride_will_start_soon,
            style:
