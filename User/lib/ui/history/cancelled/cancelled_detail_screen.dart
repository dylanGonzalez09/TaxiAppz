        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Text(
                            '${vm.translation.txt_booking_id} : ${vm.tripModel?.requestNumber}',
                            style:
              ...
              Visibility(
                  visible: vm.tripModel?.tripType?.toUpperCase() == AppConstants.local.toUpperCase(),
                  child: Align(
                    alignment: Alignment.centerRight,
                    child: InkWell(
                      onTap: () {
                        vm.handleBookAgainAction();
                      },
                      child: Container(
