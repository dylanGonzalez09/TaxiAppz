  ...
  Widget build(BuildContext context) {
    return DrawerScaffold(
      ...
      body: ChangeNotifierProvider<CancelledScreenVm>(
          create: (context) => vm,
          child: Consumer<CancelledScreenVm>(
            builder: (_, vm, child) {
              return Padding(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      else if (vm.tripData.isNotEmpty)
                        ListView.builder(
                          shrinkWrap: true,
                              ...
                              title: Padding(
                                ...
                                child: Text(
                                  vm.formatMonthDateYear(
                                      vm.history[index].date.toString(),
                                      0),
                                      ...
                                      vm.history[index].trip.length,
                                        ...
                                        final bool isDispute =
                                            trip.isCancelled == true &&
                                                trip.tripStartTime
                                                    ?.isNotEmpty ==
                                                    true &&
                                                Utils.isTripWithinTwentyFourHours(
                                                    trip.tripStartTime ??
                                                        "");

                                        final String imageUrl =
                                            "${AppConstants.imageBaseUrl}${trip.vehicleDetails?.highlightImage ?? trip.vehicleDetails?.image ?? ''}";
                                        ...
                                        return InkWell(
                                          onTap: () {
                                            ...
                                            print('dsjvdfjnjdbnjb ${trip.cancelledAt}');
                                            vm.moveToNamed(CustomRouter.cancelledDetailScreen,
                                              args: {
