...
import 'package:user/ui/tracktickets/track_tickets_vm.dart';
...
import '../../network/response_models/track_tickets_model.dart';
        ...
        child: Container(
          ...
          child: list.isNotEmpty
              ? ListView.builder(
                  ...
                  itemBuilder: (c, p) => GestureDetector(
                    onTap: () =>
                        vm.moveToNamed(CustomRouter.trackTicketsDetails, args: {
                            ...
                            children: [
                              ...
                              GestureDetector(
                                onTap: () => vm.moveToNamed(
                                    CustomRouter.trackTicketsDetails,
                                    args: {
